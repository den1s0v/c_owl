...
class AlgorithmXMLParser(AlgorithmParser):
    ...
    #         "type": "expr",
    #         "name": name,
    #         "act_name": make_translation!action()(ru=f"условие '{name}'", en=f"condition '{name}'"),
    #     }
    ...
    #         "type": "stmt",
    #         "name": name,
    #         "act_name": make_translation!action()(ru=f"действие '{name}'", en=f"statement '{name}'"),
    #     }
        ...
        if True:
            ...
            if '@type' in xml_tree and xml_tree['@type'] == 'controls_named_if':
                ...
                result.append({
                    ...
                    "type": "alternative",
                    "name": block_NAME,
                    "act_name": action('selection', name=block_NAME),
                    "branches": []
                })
                # alt branches
                branch_type = "if"
                for i in range(20):  # максимум 20 веток у альтернативы
                    ...
                    result[-1]["branches"] += [ {
                        ...
                        "type": branch_type,
                        "name": branch_name,
                        "act_name": action(branch_type, cond_name=cond_name),
                ...
                if block_ELSE:
                    ...
                    alt_obj["branches"] += [ {
                        ...
                        "type": branch_type,
                        "name": branch_name,
                        "act_name": action(branch_type, alt_name=alt_name),
