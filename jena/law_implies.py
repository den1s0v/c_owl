...
AltEndAfterBranch,AltEndAllFalse	ConditionAfterBranch
AltBranchBegin,NextAltCondition	DuplicateOfCondition
AltBranchBegin,NextAltCondition	NoNextCondition
NextAltCondition,AltEndAllFalse	BranchOfFalseCondition
AltEndAfterBranch,AltEndAllFalse	AnotherExtraBranch
AltBegin,NextAltCondition	BranchWithoutCondition
AltBranchBegin	NoBranchWhenConditionIsTrue
AltEndAllFalse,AltEndAfterBranch	LastFalseNoEnd
AltBranchBegin	AlternativeEndAfterTrueCondition
AltEndAfterBranch,AltEndAllFalse	NoAlternativeEndAfterBranch
